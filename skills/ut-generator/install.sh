...
echo ""
echo "使用方式："
echo "  在 VS Code Copilot 聊天中输入 /ut-generator 触发 skill"
echo ""
echo "  常用场景："
echo "    /ut-generator                          # 分析本地所有未提交改动"
echo "    /ut-generator --staged                 # 分析已暂存的改动"
echo "    /ut-generator abc1234                  # 分析指定 commit"
echo "    /ut-generator -- path/to/Foo.java      # 针对指定文件分析/补全 UT"
echo ""
echo "更新方式："
