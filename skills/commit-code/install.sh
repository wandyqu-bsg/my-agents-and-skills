...
echo ""
echo "下一步："
echo "  1. 重启 VS Code（让 Copilot 识别新安装的 skill）"
echo "  2. 在 Copilot Chat 中输入 / 验证：/commit-code 出现在列表中即成功"
echo ""
echo "使用方式："
echo "  在 VS Code Copilot 聊天中输入 /commit-code 触发 skill"
echo ""
echo "更新方式："
